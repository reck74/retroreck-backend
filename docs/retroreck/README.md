...
El objetivo es conservar el motor Libretro/WebRTC y añadir cuentas, biblioteca privada, salas con invitados, control de puestos, espectadores y operación de un pool de workers.
